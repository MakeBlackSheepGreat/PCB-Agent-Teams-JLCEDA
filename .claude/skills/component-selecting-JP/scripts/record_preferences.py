#!/usr/bin/env python3
"""Persist 4-axis user preferences asked by component-selecting-JP at session start.
...
用法:
    record_preferences.py --project <name> \\
        --channel {jp_domestic_fast|lcsc_jlcpcb|auto_cheapest} \\
        --brand   {japan_first|western|any} \\
...
CHANNEL_CHOICES = ("jp_domestic_fast", "lcsc_jlcpcb", "auto_cheapest")
BRAND_CHOICES = ("japan_first", "western", "any")

...
def main():
    ...
    parser.add_argument('--thermal', default=None,
                        help='analyze_thermal.py output JSON. When provided, '
                             'TH-002 ferrite-near-regulator severity is driven '
                             'by actual estimated junction temperature instead '
                             'of the proximity-only heuristic.')

...
### CK-004: No ground pour near crystal
- **Severity:** MEDIUM
- **Threshold:** Crystal has no ground zone within 5mm
- **Rationale:** A local ground pour under and around the crystal reduces parasitic coupling and improves frequency stability.
- **Fix:** Add a ground pour on the layer below the crystal, extending at least 3mm beyond the crystal footprint on all sides.
...
### ML-001: Unshielded switching inductor near sensitive circuit
- **Severity:** MEDIUM (heuristic, scaled by estimated H-field)
- **Threshold:** Unshielded / unknown-shielding power inductor within 15mm of a sensitive analog component (ADC, opamp, crystal, RF chain); magnetic-dipole H-field estimated at 1A peak ripple
- **Rationale:** Near-field coupling from switching-inductor leakage flux injects switching noise into high-impedance analog circuits.
- **Source:** Ott, *EMC Engineering*, Ch. 11 — near-field magnetic coupling.
- **Fix:** Use a shielded inductor (Coilcraft XGL/XAL, Wurth WE-MAPI, Vishay IHLP, TDK SPM) or increase separation to >15mm. Orient the inductor axis perpendicular to sensitive traces.
